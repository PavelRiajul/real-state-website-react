    ...
    <div className='flex flex-col items-center justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden' id='About'>
        ...
        <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
          ...
          <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
            ...
            <p className='my-10 max-w-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi rerum nemo in, quos expedita adipisci, numquam molestias voluptatum repellat dolorum ex animi, asperiores omnis! Error, laboriosam! Praesentium, quisquam vero aliquid quae adipisci consequuntur odit fugiat, rem ex dicta, temporibus veniam quaerat officia labore consequatur repellat accusamus voluptas ad asperiores beatae!</p>
